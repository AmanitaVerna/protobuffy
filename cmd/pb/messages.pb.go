...
func (x *ShutdownMessage) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
const file_messages_proto_rawDesc = "" +
	...
	"\x0fShutdownMessage\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04textB+Z)github.com/amanitaverna/protobuffy/cmd/pbb\x06proto3"
...
var file_messages_proto_goTypes = []any{
	...
	(*ShutdownMessage)(nil), // 1: pb.ShutdownMessage
}
